...
describe('Automatic Text Moderation', () => {
  ...
  test('Check Labels', () => {
    ...
    expectTextValue(
      wrapper.find('[testId="applyAll_channel"]'),
    ...
    expectTextValue(
      wrapper.find('[testid="tisaneApiKey"]'),
      'Tisane.ai API Key'
    );
    ...
    expectTextValue(
      wrapper.find('[testid="criminalLevel"]'),
      'Filter Level For Criminal Activity'
    );
    expectTextValue(
      wrapper.find('[testid="sexualLevel"]'),
      'Filter Level For Sexual Advances'
    );
    expectTextValue(
      wrapper.find('[testid="ProfanityLevel"]'),
      'Filter Level For Profanity'
    );
    expectTextValue(
      wrapper.find('[testid="blockOrMask"]'),
      'When profanity is detected'
    );
    expectTextValue(
      wrapper.find('[testid="setChar"]'),
  ...
  test('Check initial Values', () => {
    ...
    expect(wrapper.find('#blockOrMask').getElement().props.value).toBe(
      'mask-message'
    );
  ...
  test('Check Placeholders', () => {
    ...
    expect(wrapper.find('#tisaneApiKey').getElement().props.placeholder).toBe(
      'Tisane.ai API key'
    );
  ...
  test('SiftNinja Handler', () => {
    wrapper = shallow(
      <AutomaticProfanityMethod
        state={mockTextModerationProps('siftninja')}
        setState={jest.fn()}
      />
    );
    ...
    const SiftChannelChange = wrapper
      .find('#siftChannelName')
      .simulate('change', {
